...
<%@ page import="java.util.Date, java.text.SimpleDateFormat, edu.unizg.foi.nwtis.dskrlac20.vjezba_07_dz_2.podaci.Kazna" %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <h1>Detalji kazne</h1>
         ...
         <jsp:include page="obavijest.jsp">
          ...
          <%
                  ...
                  if (kazna != null) {
                      Date vrijemePocetak = new Date(kazna.getVrijemePocetak() * 1000);
                      Date vrijemeKraj = new Date(kazna.getVrijemeKraj() * 1000);
              %>
