...
import edu.unizg.foi.nwtis.dskrlac20.vjezba_07_dz_2.model.RestKlijentVozila;
import edu.unizg.foi.nwtis.dskrlac20.vjezba_07_dz_2.podaci.SimulacijaZrno;
import edu.unizg.foi.nwtis.dskrlac20.vjezba_07_dz_2.podaci.Vozila;
import edu.unizg.foi.nwtis.dskrlac20.vjezba_07_dz_2.podaci.VoziloZrno;
...
/**
 * Klasa {@code SimulacijeKontroler} je MVC kontroler koji upravlja operacijama
 * vezanim uz simulacije vožnji vozila. Koristi REST klijenta za dohvaćanje
 * podataka o vožnjama i pokretanje simulacija te prikazivanje tih podataka.
 *
 * @author dskrlac20
 */
@Controller
...
public class SimulacijeKontroler {
	...
	private final RestKlijentVozila restKlijentVozila = new RestKlijentVozila("simulacije");
