...
/**
 * Klasa {@code VozilaKontroler} je MVC kontroler koji upravlja operacijama
 * vezanim uz vožnje vozila. Koristi REST klijenta za dohvaćanje podataka o
 * vožnjama, pokretanje i zaustavljanje praćenja te prikazivanje tih podataka.
 *
 * @author dskrlac20
 */
@Controller
...
public class VozilaKontroler {
	...
	private final RestKlijentVozila restKlijentVozila = new RestKlijentVozila("vozila");
