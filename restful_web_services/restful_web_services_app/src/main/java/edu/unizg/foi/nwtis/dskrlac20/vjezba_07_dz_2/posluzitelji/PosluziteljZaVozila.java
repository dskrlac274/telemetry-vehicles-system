...
import edu.unizg.foi.nwtis.dskrlac20.vjezba_07_dz_2.posluzitelji.radnici.RadnikZaVozila;
		...
		try (AsynchronousServerSocketChannel serverskiKanal = AsynchronousServerSocketChannel
			...
			while (!Thread.currentThread().isInterrupted()) {
				...
				if (aktivniKanali.size() < centralniSustav.maksVozila) {
					...
					tvornicaVirtualnihDretvi.newThread(new RadnikZaVozila(this, klijentskiKanal))
							.start();
				} else {
