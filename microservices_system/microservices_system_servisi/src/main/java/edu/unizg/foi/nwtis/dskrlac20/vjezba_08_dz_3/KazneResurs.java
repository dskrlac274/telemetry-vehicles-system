...
/**
 * Klasa {@code KazneResurs} je resurs RESTful web servisa za upravljanje kaznama. Omogućuje dohvat,
 * dodavanje i provjeru stanja kazni.
 *
 * @author dskrlac20
 */
...
public class KazneResurs {
  ...
  public Response provjeriStanjePosluziteljaKazni() {
    var odgovor = MrezneOperacije.posaljiZahtjevPosluzitelju(adresaKazne,
        mreznaVrataKazne, "TEST");
  ...
  private void preuzmiPostavke() throws Exception {
    mreznaVrataKazne = Integer.parseInt( (String) kontekst.getAttribute("app.kazne.mreznaVrata"));
    adresaKazne = (String) kontekst.getAttribute("app.kazne.adresa");
    putanjaNadzora = (String) kontekst.getAttribute("webservis.klijenti.nadzor.baseuri");
  }
}
