 ...
 */
@Entity
@NamedQueries({ @NamedQuery(name = "Kazne.findAll", query = "SELECT k FROM Kazne k") })
public class Kazne implements Serializable {
	...
	public Kazne(Integer rb, long vrijemepocetak, long vrijemekraj, double brzina, double gpssirina, double gpsduzina,
			double gpssirinaradar, double gpsduzinaradar) {
		this.rb = rb;
