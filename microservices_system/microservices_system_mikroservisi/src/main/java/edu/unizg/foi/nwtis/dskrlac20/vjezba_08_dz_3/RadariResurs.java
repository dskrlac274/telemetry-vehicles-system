...
public class RadariResurs {
  ...
  private void preuzmiPostavke() throws RuntimeException {
    ...
    adresaPosluziteljaZaRegistraciju =
        config.get("app.radari.adresa").asString().orElse("localhost");
    mreznaVrataPosluziteljaZaRegistraciju =
        config.get("app.radari.mreznaVrata").asInt().orElse(8000);
  }
}
