...
import edu.unizg.foi.nwtis.dskrlac20.vjezba_08_dz_3.klijenti.RestKlijentKazne;
import edu.unizg.foi.nwtis.dskrlac20.vjezba_08_dz_3.podaci.Kazna;
import edu.unizg.foi.nwtis.dskrlac20.vjezba_08_dz_3.podaci.PodaciKazne;
...
public class PosluziteljKazni {
    private String restServisKazne;
    ...
    public void preuzmiPostavke(String datotekaKonfiguracije)
        ...
        this.restServisKazne = konfig.dajPostavku("webservis.kazne.baseuri");
    }
    ...
    private boolean posaljiZahtjevNaRestServis(PodaciKazne podaciKazne) {
        var restKlijentKazne = new RestKlijentKazne(restServisKazne);
