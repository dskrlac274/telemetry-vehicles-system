...
import edu.unizg.foi.nwtis.dskrlac20.vjezba_08_dz_3.podaci.RedPodaciVozila;
...
public class CentralniSustav {
    ...
    public void preuzmiPostavke(String datotekaKonfiguracije)
        ...
        this.baseUri = konfiguracija.dajPostavku("webservis.vozila.baseuri");
    }
    ...
    public void pokreniPosluzitelje() {
        PosluziteljZaRegistracijuRadara posluziteljZaRegistracijuRadara = new PosluziteljZaRegistracijuRadara(
            this);
        PosluziteljZaVozila posluziteljZaVozila = new PosluziteljZaVozila(this, baseUri);
