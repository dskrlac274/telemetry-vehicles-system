...
public class Voznje implements Serializable {
    ...
    public Voznje(Integer rb) {
        this.rb = rb;
    }

    public Voznje(Integer rb, int id, int broj, long vrijeme, double brzina, double snaga, double struja, double visina, double gpsbrzina, int tempvozila, int postotakbaterija, double naponbaterija, int kapacitetbaterija, int tempbaterija, double preostalokm, double ukupnokm, double gpssirina, double gpsduzina) {
        this.rb = rb;
        this.id = id;
        this.broj = broj;
