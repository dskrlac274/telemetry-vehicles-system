 ...
 * @param broj              broj retka iz datoteke podataka koju SimulatorVozila
 *                          koristi u radu
 ...
 */
public record PodaciVozila(int id, int broj, long vrijeme, double brzina, double snaga, double struja, double visina,
