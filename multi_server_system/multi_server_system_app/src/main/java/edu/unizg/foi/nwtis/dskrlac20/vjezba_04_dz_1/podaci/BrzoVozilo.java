 ...
 * @param broj      broj retka iz datoteke podataka koju SimulatorVozila koristi
 *                  u radu
 ...
 * @param status    status zapisa. true početak brze vožnje, false nije brza
 *                  vožnja
 */
public record BrzoVozilo(int id, int broj, long vrijeme, double brzina, double gpsSirina, double gpsDuzina,
		boolean status) {
	/**
	 * Postavi status.
	 *
