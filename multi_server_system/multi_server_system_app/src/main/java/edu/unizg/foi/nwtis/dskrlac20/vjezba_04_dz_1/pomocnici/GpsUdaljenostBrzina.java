package edu.unizg.foi.nwtis.dskrlac20.vjezba_04_dz_1.pomocnici;

/**
 * Klasa GpsUdaljenostBrzina. Implementacija Haversine formule preuzeta iz
 * <a href=
 * "https://introcs.cs.princeton.edu/java/12types/GreatCircle.java.html">Implementacija</a>
 */
public class GpsUdaljenostBrzina {
	...
	public static double udaljenostKm(double x1, double x2, double y1, double y2) {
		return udaljenostNm(x1, x2, y1, y2) * 1.852;
	}
}
