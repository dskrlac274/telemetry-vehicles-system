...
import edu.unizg.foi.nwtis.dskrlac20.vjezba_04_dz_1.podaci.RedPodaciVozila;
...
public class CentralniSustav {
	...
	public void preuzmiPostavke(String datotekaKonfiguracije) throws NeispravnaKonfiguracija, NumberFormatException {
		Konfiguracija konfiguracija = KonfiguracijaApstraktna.preuzmiKonfiguraciju(datotekaKonfiguracije);
	...
	public void pokreniPosluzitelje() {
		PosluziteljZaRegistracijuRadara posluziteljZaRegistracijuRadara = new PosluziteljZaRegistracijuRadara(this);
		PosluziteljZaVozila posluziteljZaVozila = new PosluziteljZaVozila(this);

		Thread posluziteljZaRegistracijuRadarDretva = tvornicaDretvi.newThread(posluziteljZaRegistracijuRadara);
