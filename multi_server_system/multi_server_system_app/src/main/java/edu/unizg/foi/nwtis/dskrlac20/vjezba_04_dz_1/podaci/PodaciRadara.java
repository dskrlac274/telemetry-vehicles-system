package edu.unizg.foi.nwtis.dskrlac20.vjezba_04_dz_1.podaci;
 ...
 * @param maksUdaljenost          maksimalna udaljenost do koje radar mjeri
 *                                brzinu
 * @param adresaRegistracije      adresa poslužitelja za registraciju radara
 * @param mreznaVrataRegistracije mrezna vrata poslužitelja za registraciju
 *                                radara
 ...
 */
public record PodaciRadara(int id, String adresaRadara, int mreznaVrataRadara, int maksBrzina, int maksTrajanje,
		int maksUdaljenost, String adresaRegistracije, int mreznaVrataRegistracije, String adresaKazne,
		int mreznaVrataKazne, String postanskaAdresaRadara, double gpsSirina, double gpsDuzina) {
}
